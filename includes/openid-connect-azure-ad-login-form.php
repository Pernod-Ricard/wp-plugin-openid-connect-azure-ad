...
class OpenID_Connect_Azure_AD_Login_Form {
	 ...
	 * @param $client_wrapper
	 *
	 * @return \OpenID_Connect_Azure_AD_Login_Form
	 */
	static public function register( $settings, $client_wrapper ){
		...
		add_shortcode( 'openid_connect_azure_ad_login_button', array( $login_form, 'make_login_button' ) );
	...
	function make_login_button() {
		$text = apply_filters( 'openid-connect-azure-ad-login-button-text', __( 'Login with OpenID Connect' ) );
