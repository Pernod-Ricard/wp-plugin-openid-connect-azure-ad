...
/**
 * Class OpenID_Connect_Azure_AD_Settings_Page.
 * Admin settings page.
 */
class OpenID_Connect_Azure_AD_Settings_Page {
	...
	// options page slug
	private $options_page_name = 'openid-connect-azure-ad-settings';
	...
	function __construct( OpenID_Connect_Azure_AD_Option_Settings $settings, OpenID_Connect_Azure_AD_Option_Logger $logger ) {
		...
		$fields = array(
			...
			'client_id'         => array(
				...
				'description' => __( 'The ID of the application registered in Azure AD.' ),
			...
			'client_secret'     => array(
				...
				'description' => __( 'Value of one of the generated client secrets' ),
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'scope'             => array(
				'title'       => __( 'OpenID Scope' ),
				'description' => __( 'Space separated list of scopes.' ),
			...
			'endpoint_login'    => array(
				...
				'example'     => 'https://login.microsoftonline.com/{directory (tenant) id}/oauth2/authorize',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'endpoint_userinfo' => array(
				...
				'example'     => 'https://login.microsoftonline.com/{directory (tenant) id}/openid/userinfo',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'endpoint_token'    => array(
				...
				'example'     => 'https://login.microsoftonline.com/{directory (tenant) id}/oauth2/token',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'endpoint_end_session'    => array(
				...
				'example'     => 'https://login.microsoftonline.com/{directory (tenant) id}/oauth2/v2.0/logout',
				'type'        => 'text',
				'section'     => 'client_settings',
			),
			'identity_key'     => array(
		...
		$fields = apply_filters( 'openid-connect-azure-ad-settings-fields', $fields );
	 ...
	 * @param \OpenID_Connect_Azure_AD_Option_Logger $logger
	 *
	 * @return \OpenID_Connect_Azure_AD_Settings_Page
	 */
	static public function register( OpenID_Connect_Azure_AD_Option_Settings $settings, OpenID_Connect_Azure_AD_Option_Logger $logger ){
